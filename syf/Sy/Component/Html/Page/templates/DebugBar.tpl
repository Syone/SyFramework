	...
	<div id="sy_debug_console_content" style="<?php echo $RESET_CSS ?> height: 270px; border-top: 1px solid #999; background-color: #FFF; display: none;">
		...
		<div id="sy_debug_log_content" style="<?php echo $RESET_CSS ?> height: 100%; overflow: auto; position: relative;">
			...
			<div id="sy_debug_log_filter_div" style="<?php echo $RESET_CSS ?> display: none; position: absolute; padding: 3px; background-color: #CCC; border-bottom: 1px solid #AAA; border-right: 1px solid #AAA;">
				<img class="sy_debug_filter_checked" onclick="sy_debug_log_filter(this, 'green')" style="<?php echo $RESET_CSS ?> cursor: pointer; float: none; border: 1px solid #375D81; background-color: #ABC8E2; padding: 2px; vertical-align: middle;" alt="Green" src="data:image/png;base64,<?php echo $FLAGS[Sy\Debug\Log::NOTICE] ?>" />
				<img class="sy_debug_filter_checked" onclick="sy_debug_log_filter(this, 'orange')" style="<?php echo $RESET_CSS ?> cursor: pointer; float: none; margin-left: 10px; border: 1px solid #375D81; background-color: #ABC8E2; padding: 2px; vertical-align: middle;" alt="Orange" src="data:image/png;base64,<?php echo $FLAGS[Sy\Debug\Log::WARN] ?>" />
			...
			<table style="<?php echo $TABLE_RESET_CSS ?> width: 100%;">
				...
				<tr class="sy_debug_log_row_<?php echo $COLOR_NAMES[$log->getLevel()] ?>" style="<?php echo $RESET_CSS ?>">
					...
					<td style="<?php echo $TD_CSS ?> background-color: <?php echo $S_COLORS[$log->getLevel()] ?>"><?php echo htmlentities($log->getMessage()) ?></td>
				</tr>
				<?php endforeach ?>
			</table>
		</div>
