...
<div style="position: fixed; bottom: 0; left: 0; width: 100%; background-color: #EEE; font-family: arial, sans-serif;">
	...
	<div id="sy_debug_bar" style="border-top: 1px solid #999; font-size: 11px; height: 30px;">
		...
		<a id="sy_debug_log_content_title" href="#" style="text-decoration: none; background-color: transparent; color: #777;" onclick="sy_debug_show_content('log'); return false;">Logs <span style="color:red"><?php echo $NB_ERROR ?></span></a>
